...
3. 报错截图：从 vConsole 显示的信息可以得知是 js 报错导致的白屏，具体是对 undefined 调用了 replace 方法。
   ...
   ![1](https://public.litong.life/yue/1.jpg)
...
![20](https://public.litong.life/yue/20.png)
...
![21](https://public.litong.life/yue/21.png)
...
![8](https://public.litong.life/yue/8.png)
...
2. B页面第一次调用localStorage.getItem时，读取到的数据不符合预期，未包含state字段。
  ...
  ![28](https://public.litong.life/yue/28.png)
...
![27](https://public.litong.life/yue/27.png)
...
![29](https://public.litong.life/yue/29.png)
...
![30](https://public.litong.life/yue/30.png)
...
![19](https://public.litong.life/yue/19.png)
...
![22](https://public.litong.life/yue/22.png)
